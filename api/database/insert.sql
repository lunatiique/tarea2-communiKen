-- Insert users
INSERT INTO usuario (direccion_correo, clave, nombre, descripcion, fecha_creacion) VALUES
('alice@example.com', 'alice123', 'Alice', 'Alice Description', '2023-01-01'),
('bob@example.com', 'bob123', 'Bob', 'Bob Description', '2023-01-02'),
('carol@example.com', 'carol123', 'Carol', 'Carol Description', '2023-01-03'),
('dave@example.com', 'dave123', 'Dave' ,'Dave Description', '2023-01-04'),
('eve@example.com', 'eve123', 'Eve' ,'Eve Description', '2023-01-05');
